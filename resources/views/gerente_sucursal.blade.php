...
<head>
    ...
    <title>Banco de Agricultura Salvadoreño SA de CV - Gerente de Sucursal</title>
    <!-- Estilos CSS -->
...
<body>
    <div class="container mt-5">
        ...
        <form action="{{ route('gerente.sucursal.ingresarEmpleado') }}" method="POST">
            @csrf
        ...
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $caso->estado }}</td>
                    <td>
                        <a href="{{ route('gerente.sucursal.aprobarPrestamo', ['id' => $caso->id]) }}" class="btn btn-success">Aprobar</a>
                        <a href="{{ route('gerente.sucursal.rechazarPrestamo', ['id' => $caso->id]) }}" class="btn btn-danger">Rechazar</a>
                    </td>
                </tr>
                @endforeach
            </tbody>
